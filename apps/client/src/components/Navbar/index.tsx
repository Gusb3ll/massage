    ...
    <>
      <div className='hidden sm:block'>
        <div className="navbar bg-base-100 h-[80px] border shadow-md">
          ...
          <div className="gap-4 rounded-xl w-[27rem]">
            <div className="relative w-[20rem] md:w-[20rem]">
              <input
                type="text"
                placeholder="Search Your Location"
                className="input input-bordered rounded-full w-full border-black pl-10"
              />
              <IoSearchSharp className="absolute left-3 top-1/2 transform -translate-y-1/2 text-black text-xl" />
            </div>
            <button className="btn btn-sm w-[70px] placeholder:bg-[#854C2F] rounded-2xl border-[#000000] bg-[#ffffff]">
              Login
            </button>
          </div>
        </div>
